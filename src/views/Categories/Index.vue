    ...
    <div class="common" :style="{
      ...
      backgroundSize: 'cover',
        ...
        <div :class="isPC ? 'content' : 'wap-content'">
            <div class="cols">
                <div class="cols-item" @click="goDetail(1)">
                <div class="container">
                    <div
                    class="front"
                    :style="{
                ...
                <div class="cols-item" @click="goDetail(2)">
                <div class="container">
                    <div
                    class="front"
                    :style="{
                ...
                <div class="cols-item" @click="goDetail(3)">
                <div class="container">
                    <div
                    class="front"
                    :style="{
                ...
                <div class="cols-item" @click="goDetail(4)">
                <div class="container">
                    <div
                    class="front"
                    :style="{
